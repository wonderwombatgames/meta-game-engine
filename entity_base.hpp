...
namespace System {
    ...
    private:
        ...
        EntityID registerIn(SystemsInterface& system)
        {
            return this->registerIntoSystem(system);
        }
        ErrorCode registerOff(SystemsInterface& system)
        {
            return this->deregisterFromSystem(system);
        }
...
protected:
    // add one more component to the entity
    virtual EntityID
    registerIntoSystem(System::SystemsInterface& system) override;
    // remove one more component to the entity
    virtual ErrorCode
    deregisterFromSystem(System::SystemsInterface& system) override;
